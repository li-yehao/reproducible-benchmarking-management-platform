  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="job_id">
             ...
             <el-input v-model.number="searchInfo.job_id" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="catlog">
         <el-input v-model="searchInfo.catlog" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="sub_catlog">
         <el-input v-model="searchInfo.sub_catlog" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="key_info">
         <el-input v-model="searchInfo.key_info" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="info_value">
         <el-input v-model="searchInfo.info_value" placeholder="搜索条件" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="catlog:"  prop="catlog" >
          <el-input v-model="formData.catlog" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="sub_catlog:"  prop="sub_catlog" >
          <el-input v-model="formData.sub_catlog" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="key_info:"  prop="key_info" >
          <el-input v-model="formData.key_info" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="info_value:"  prop="info_value" >
          <el-input v-model="formData.info_value" :clearable="true"  placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
